...
import app.pb2.eds_pb2 as eds__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in eds_pb2_grpc.py depends on'
...
def add_EdsServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'eds.EdsService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('eds.EdsService', rpc_method_handlers)
